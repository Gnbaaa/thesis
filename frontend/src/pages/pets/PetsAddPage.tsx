  ...
  if (!loggedIn) {
    return (
      <section className="w-full max-w-[640px]">
        <h1 className="text-2xl font-semibold text-text-heading">{t('pets.create.title')}</h1>
        ...
        <div className="mt-4">
          <Link to="/pets" className={cn(btnSecondary, focusRing, 'inline-flex h-10 items-center justify-center px-4')}>
            {t('pets.create.backList')}
          </Link>
        </div>
      </section>
    );
  ...
  return (
    <section className="w-full max-w-[880px]">
      <div>
        ...
        <h1 className="mt-2 text-2xl font-semibold text-text-heading">{t('pets.create.title')}</h1>
      </div>
      <p className="mt-2 text-sm text-text-muted">{t('pets.create.subtitle')}</p>
      ...
      >
        ...
        <div className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2">
          <div>
            ...
            <div
              className={cn('mt-2 flex flex-wrap gap-6 rounded-lg border border-border-input bg-surface-card px-3 py-2.5', focusRing, 'ring-offset-0')}
            >
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button type="button" className={cn(btnSecondary, focusRing, 'h-11 min-w-[120px] px-4')} onClick={() => navigate(-1)}>
